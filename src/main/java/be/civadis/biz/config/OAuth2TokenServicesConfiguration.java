...
import be.civadis.biz.multitenancy.CustomServiceUserInfoTokenServices;
...
import be.civadis.biz.security.oauth2.CachedUserInfoTokenServices;
import be.civadis.biz.security.oauth2.SimpleAuthoritiesExtractor;
import be.civadis.biz.security.oauth2.SimplePrincipalExtractor;
...
public class OAuth2TokenServicesConfiguration {
    ...
    @Bean
    @Primary
    //ATTENTION, PATCH de la config Jhipster, on utilise CustomServiceyUserInfoTokenServices
