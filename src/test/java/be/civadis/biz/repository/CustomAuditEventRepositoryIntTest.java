...
import be.civadis.biz.config.audit.AuditEventConverter;
import be.civadis.biz.domain.PersistentAuditEvent;
...
import static be.civadis.biz.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
